...
| ID | 任务 | 关联 | 类型 | 预估 | 验收 | 状态 |
|----|------|------|------|------|------|------|
| TASK-M3P-01 | 财务分析专业组件 | [plan-§M3+][US-005][spec-DD-5] | feat | L | 偿债/盈利/营运/现金流四维分析模板，每项指标显示趋势和行业对标 | ⬜ 待开始 |
| TASK-M3P-02 | 行业对标分析组件 | [plan-§M3+][US-006][spec-DD-5] | feat | M | 企业指标 vs 行业 P25/P50/P75，偏离 >20% 高亮 | ⬜ 待开始 |
| TASK-M3P-03 | 报告完成度仪表盘 | [plan-§M3+][US-007][spec-DD-6] | feat | M | 实时显示各章节完成状态，整体 <80% 禁止提交审批 | ⬜ 待开始 |
| TASK-M3P-04 | 智能填充建议 | [plan-§M3+][US-008] | feat | M | 光标定位空白章节时显示"AI 建议"按钮，基于已有数据生成建议 | ⬜ 待开始 |
| TASK-M3P-05 | 提示词模板管理 | [plan-§M3+][US-010] | feat | M | 按行业/风险类型管理提示词模板，支持变量替换 | ⬜ 待开始 |
| TASK-M3P-06 | 工作流编排可视化 | [plan-§M3+][US-009] | feat | L | 拖拽式节点编排，支持条件分支，工作流版本管理 | ⬜ 待开始 |
...
| v1.3 | 2026-05-07 | 新增 M3+ 业务能力深化任务（6 项）：财务分析/行业对标/报告完成度/智能填充/提示词管理/工作流编排 |
