...
> **依据**：`docs/UNIFIED_VISUAL_MASTERPLAN.md`（两轮收敛 §6）、`docs/UI_DESIGN_SPEC.md`（PageHeader / SplitPane / KPI 上限）、`docs/sdd/plan.md`（pages 薄层、组件化骨架）。
...
与 `docs/sdd/test.md` v1.1 对齐：**本轮不以覆盖率门槛阻塞**，以手工回归为主：
