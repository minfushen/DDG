...
**目标文件**：
- `docs/architecture/memory-system-spec.md` — 设计规格：架构、表结构、接口、决策树
- `docs/guides/memory-usage.md` — 使用说明：配置、API、最佳实践
- `docs/specs/tasks.md` — 更新：添加记忆系统任务条目
...
| `docs/architecture/memory-system-spec.md` | 新增 | 设计规格 |
| `docs/guides/memory-usage.md` | 新增 | 使用说明 |
| `docs/specs/tasks.md` | 编辑 | 添加任务条目 |
