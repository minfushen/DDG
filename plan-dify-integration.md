...
**目标文件**：
- `dify-workflows/due_diligence_chatflow.json` — Dify Chatflow 配置
- `dify-workflows/simple_qa_chatflow.json` — 简单问答 Chatflow 配置
...
**目标文件**：
- `dify-embed/index.html` — Dify 嵌入页面
- `dify-embed/README.md` — 部署说明
...
**目标文件**：
- `docs/dify-integration/README.md` — 集成总览
- `docs/dify-integration/api-reference.md` — Dify 适配 API 参考
- `docs/dify-integration/chatflow-setup.md` — Chatflow 配置指南
- `docs/dify-integration/security.md` — 安全/数据合规指南
...
| `dify-workflows/due_diligence_chatflow.json` | 新增 | 深度尽调 Chatflow |
| `dify-workflows/simple_qa_chatflow.json` | 新增 | 简单问答 Chatflow |
| `dify-embed/index.html` | 新增 | Dify 嵌入页面 |
| `docs/dify-integration/README.md` | 新增 | 集成文档 |
| `docs/dify-integration/api-reference.md` | 新增 | API 参考 |
| `docs/dify-integration/chatflow-setup.md` | 新增 | Chatflow 配置指南 |
| `docs/dify-integration/security.md` | 新增 | 安全指南 |
