        ...
        <div className="space-y-6">
          ...
          <section className="rounded-2xl border border-gray-200 bg-white overflow-hidden">
            ...
            <div className="px-6 pb-6">
              {/* 上传区 */}
              <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-blue-400 hover:bg-blue-50/50 transition-colors cursor-pointer mb-6">
                <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-blue-100 flex items-center justify-center">
                  <Upload className="h-6 w-6 text-blue-600" />
                </div>
                <p className="text-gray-700 font-medium">拖拽文件到此处上传，或点击选择</p>
                <p className="text-sm text-gray-500 mt-1">支持 PDF、Excel、图片、音频等格式</p>
              </div>
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-5">
            ...
            <button
              ...
              disabled={!allDone}
              className={`w-full h-12 rounded-lg text-sm font-medium transition-colors inline-flex items-center justify-center gap-2 ${
                allDone
